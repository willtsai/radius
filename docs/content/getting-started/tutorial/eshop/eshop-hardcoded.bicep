...
param IDENTITY_API string = 'http://identity-api'
param IDENTITY_PORT string = '5105'
...
resource eshop 'radius.dev/Applications@v1alpha1' = {
  ...
  resource ordering 'Components' = {
    ...
    properties: {
      run: {
        container: {
          ...
          env: {
            ...
            'GRPC_PORT': '81'
            'PORT': '80'
            'identityUrl': '${IDENTITY_API}'
            'IdentityUrlExternal': '${IDENTITY_API}:${IDENTITY_PORT}'
          }
        }
      }
      bindings: {
      ...
      uses:[
        ...
        /* PENDING https://github.com/Azure/radius/issues/893
        {
      ...
      uses: [
        {
          ...
          env:{
            'ConnectionString': redis.properties.bindings.redis.connectionString
          }
        }
        {
          binding: servicebus.properties.bindings.default
      ...
      run: {
        container: {
          ...
          env: {
            ...
            'IdentityUrlExternal': 'http://identity-api:5105'
          }
        }
      }
      bindings: {
      ...
      run: {
        container: {
          ...
          env: {
            ...
            'IdentityUrl': '${IDENTITY_API}'
            'IdentityUrlExternal': '${IDENTITY_API}:${IDENTITY_PORT}'
            'IdentityUrlHC': 'http://${IDENTITY_API}/hc'
  ...
  resource webmvc 'Components' = {
    ...
    properties: {
      ...
      uses: [
        {
          binding: redis.properties.bindings.redis.connectionString
          env:{
            'DPConnectionString': redis.properties.bindings.redis.connectionString
          }
        }
        /*
        {
        ...
        */
        /*
        {
          binding: webshoppingapigw.properties.bindings.http
          env:{
            'PurchaseUrl': webshoppingapigw.properties.bindings.http.host
          }
        }
        */
        /*
